            ...
            <div class="navbar navbar-default navbar-top">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="/fyp/index.jsp">CRMB</a>
                    </div>
                    <div class="navbar-collapse collapse">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li>
                                <a class="active" href="/fyp/personalityIndex.jsp">about mbti</a>
                            </li>
                            <li>
                ...
                <div class="row">
                    <div class="col-md">
                        ...
                        <div class="footer-address">
                            <ul>
                                <li class="footer-contact"><i class="fa fa-home"></i>23.6 Jalan Permatang Serai, Merlimau Melaka</li>
								<li class="footer-contact"><i class="fa fa-phone"></i>013-6312046</li>
                                <li class="footer-contact"><i class="fa fa-globe"></i><a href="#" target="_blank">www.masjidjamekarrahim.blogspot.com</a></li>
                            </ul>
                        </div>
                    </div><!--/.col-md-3 -->
