    ...
    <section class="fun-facts"> 
       ...
       <c:forEach items="${subjects}" var="subject">
                ...
                <tr>
                    ...
                    <td><a href="adminController?action=deleteSubject&subjectId=<c:out value="${subject.subjectId}" />">Delete Subject</td>
                    <!-- <td><a href="studentController?action=view&subjectId=<c:out value="${subject.subjectId}"/>">Lihat Penuh</td> -->
                </tr> 
    </c:forEach>
    </table>
    <p align="center"><a href="adminController?action=addSubject&adminEmail=<c:out value="${subject.adminEmail}"/>" class="btn btn-primary" >Add Subject</a></p>
    </form> 
    		</div>
    </div>
    </div>
