                    ...
                    <div class="navbar-collapse collapse">
                       ...
                       <!-- Start Navigation List -->
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li>
                                <a class="active" href="/fyp/indexAdmin.jsp">Admin</a>
                            </li>
                            <li>
                              	<a href="/fyp/adminLogIn.jsp">Log Keluar</a>
                            </li>
         ...
         <h3>ADD NEW SUBJECT</h3>
            <div class="row"> 
                <div class="col-xs-12 col-sm-12 col-md-12" data-wow-duration="2s" data-wow-delay="300ms">      
							<form method="post" action="adminController?action=subject">
							<table border="0" width="50%" align="center">
									<tr>
                          				<th><label>Subject ID:</label><br><br></th>
                          				<th><input class="form-control"type="text" name="subjectId" id="subjectId" > <br></th>
									</tr>
									<tr>
                          				<th><label>Subject Name:</label><br><br></th>
                          				<th><input class="form-control" type="text" name="subjectName" id="subjectName"> <br></th>
									</tr>
									
                          			<tr>
                          				<th  colspan="2">
                          				<br><br> <p align="center"><input type="submit" value="Submit" class="btn btn-primary"> <input type="reset" value="Reset" class="btn btn-primary"></p>
                          				</th>
                          			</tr>
