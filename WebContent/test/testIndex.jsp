...
<body>
 <header class="clearfix">
            ...
            <div class="navbar navbar-default navbar-top">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="/fyp/index.jsp">Course Recommendation Based on Myers-Briggs Theory</a>
                    </div>
                    <div class="navbar-collapse collapse">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li>
                                <a class="active" href="/fyp/addStudent.jsp">Student</a>
                            </li>
                            <li>
                                <a class="active" href="/fyp/adminLogIn.jsp">Admin</a>
                            </li>
                            <li>
                                <a class="active" href="/fyp/PersonalityDesc.jsp">About MBTI</a>
                            </li>
                            <li>
        ...
        <br>
        <br>
        <h3 align="center">What is Extrovert, Sensing, Intution, Thinking, Feeling, Judging and Perceiving?</h3>
        <br>
        <br>
        <h3 align="center">How many question will I answer?</h3>
        <br>
        <br>
        <h3 align="center">How long does it take?</h3>
        <br>
        <br>
        <h3 align="center">What will I learn from my personality result ?</h3>
</body>
</html>